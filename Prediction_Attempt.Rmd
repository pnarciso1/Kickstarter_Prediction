...
## 
In this project, we will explore the characterisitcs of projects on Kickstarter and try to understand what separates the winners from the projects that failed to reach their funding goals. 
...
<br />We will use the smaller set to test the accuracy of my algorithm.
